...
const LessonListPage = () => {
  ...
  { header: t("col.day"), accessor: "day", className: "hidden md:table-cell" },
  { header: t("col.time"), accessor: "time", className: "hidden lg:table-cell" },
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">{t("titles.lessons")}</h1>
