...
const ContentListPage = () => {
  ...
  { header: t("col.type"), accessor: "type" },
  { header: t("col.subject"), accessor: "subject", className: "hidden md:table-cell" },
  { header: t("col.class"), accessor: "class", className: "hidden md:table-cell" },
  { header: t("col.teacher"), accessor: "teacher", className: "hidden lg:table-cell" },
  { header: t("col.status"), accessor: "status", className: "hidden lg:table-cell" },
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">{t("titles.content")}</h1>
