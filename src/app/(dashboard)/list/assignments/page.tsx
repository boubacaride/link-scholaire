...
const AssignmentListPage = () => {
  ...
  const canEdit = isAdmin || role === "teacher";

  const { data, loading } = useSupabaseQuery<AssignmentRow>({
    table: "content",
    ...
    filters: [{ column: "type", value: "assignment" }],
  ...
  if (loading) {
    return <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">Loading assignments...</div>;
  }
